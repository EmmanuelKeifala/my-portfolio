...
export default function Dialog({title, onClose, onOk, children}) {
  ...
  const dialogRef = useRef(null); // Use useRef hook
  ...
  const dialog = (
    ...
    <dialog
      ...
      <div className="w-full max-w-full bg-gray-200 flex flex-col">
        <div className="flex flex-row justify-between mb-4 pt-2 px-5 bg-dark-blue">
